//! Graph Shortest-Paths WASM agent.
//! Handles shortest path requests — returns RESULT with intent=44 (SHORTEST).
#![no_std]
use core::slice;
...
const INTENT_OUT: u8  = 44; // SHORTEST intent
...
pub unsafe extern "C" fn handle_block(ptr: *const u8, len: usize) -> *mut u8 {
    ...
    // Echo payload_ref as start node
